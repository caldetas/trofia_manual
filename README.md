...
- Ihr kleines rotes Halsband ist nur für die Plakette und nicht für die Leine geeignet.
- Fütterung: Morgens und abends zwei kleine silberne Tassen Trockenfutter und ein viertel oder eine halbe Packung Nassfutter..
- Gudies und Kauknochen helfen nach belieben.
- **Sie ist stubenrein**, kann auch gut eine Nacht aushalten. Wenn sie muss, kommt sie uns normalerweise anstupsen oder an den Zehen knabbern, sitzt flehend vor dir hin.

---

## Beim Spazierengehen:
- Immer an der Leine, wo es Autos gibt. Sie jagt Vögel, Katzen, Igel, Kinder, generell alles kleine was sich bewegt.
- An ungefährlichen Orten kann sie nach eigenem Ermessen von der Leine gelassen werden. Bei uns geht sie nicht ausser Sichweite. In den ersten Tagen vorsichtig, wir können eine Schleppleine mitgeben zum langsamen herantasten an den Freilauf.
- Wenn sie bei dir entspannen kann und ruhig ist, dann klappt es auch wahrscheinlich auch beim Freilauf. Weniger Hundeerfahrene bitte vorsichtig, sie ist ein bisschen nervös und sehr schnell.

---

## Sozialverhalten:
- Mit Kindern vorsichtig, sie können triggern. Hundeerfahrene Kinder ohne Angst sind in der Regel kein Problem. Mit Hunden kommt sie gut zurecht.
- Sie beisst eigentlich nicht zu, auch bei Vögeln oder Katzen bis jetzt noch nicht, jagt aber gern nach und macht sich gross wenn sie Angst hat.
